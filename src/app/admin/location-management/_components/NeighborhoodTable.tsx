          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.length === 0 ? (
              ...
              data.map((neighborhood) => (
                <tr key={neighborhood.neighborhood_id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{neighborhood.neighborhood_name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{neighborhood.district_name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{neighborhood.city_name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{neighborhood.country_name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{neighborhood.slug}</td>
